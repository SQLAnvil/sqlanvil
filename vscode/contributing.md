...
- In the main repo run `bazel run vscode:packager /tmp/sqlanvil-package.vsix`
- Take the generated package and upload it [here](https://marketplace.visualstudio.com/manage/publishers/ihistand)
