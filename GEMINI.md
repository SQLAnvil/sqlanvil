...
- **Writing sqlanvil data projects** (`.sqlx`, `workflow_settings.yaml`, `.df-credentials.json`
  for PostgreSQL / Supabase): follow [`AGENTS.md`](./AGENTS.md). It is the cross-agent authoring
  guide and corrects the Dataform/BigQuery assumptions that produce broken sqlanvil code.
